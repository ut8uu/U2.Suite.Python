...
"")
        ...
        self.menuExport.addAction(self.actionExportToADIFfile)
        self.menuExport.addAction(self.actionExportToADXfile)
        self.menuLog.addAction(self.actionStation_info)
        self.menuLog.addSeparator()
        self.menuLog.addAction(self.menuImport.menuAction())
        self.menuLog.addAction(self.menuExport.menuAction())
    ...
    def retranslateUi(self, LoggerMainWindow):
        ...
        self.menuExport.setTitle(_translate("LoggerMainWindow", "Export"))
