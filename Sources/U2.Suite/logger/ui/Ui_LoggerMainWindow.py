...
class Ui_LoggerMainWindow(object):
    def setupUi(self, LoggerMainWindow):
        ...
        LoggerMainWindow.setTabOrder(self.btnF11, self.tbSnt)
        ...
        LoggerMainWindow.setTabOrder(self.btnF6, self.tbCallsign)
        LoggerMainWindow.setTabOrder(self.tbCallsign, self.btnF7)
