...
# File was modified by Sergey Usmanov, UT8UU
# Original file can be found on its source repository at https://github.com/bmo/py-wsjtx
...
class WSJTXPacketClassFactory(GenericWSJTXPacket):
    ...
    PACKET_TYPE_TO_OBJ_MAP = {
        ...
        LocationChangePacket.TYPE_VALUE: LocationChangePacket,
